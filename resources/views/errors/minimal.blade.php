    ...
    <head>
        ...
        <style>
            ...
            .refresh-button {
                ...
                color: rgb(192, 187, 187); /* Warna teks */
                text-transform: uppercase; /* Mengubah teks menjadi huruf kapital */
                border: 1px solid #fff; /* Border dengan warna putih */
                padding: 0.5rem 1rem; /* Padding di atas dan bawah 0.5rem, padding di sisi kiri dan kanan 1rem */
                border-radius: 0.25rem; /* Radius sudut tombol */
                ...
                transition: background-color 0.3s, color 0.3s; /* Efek transisi ketika tombol dihover */
            }
        </style>
    </head>
